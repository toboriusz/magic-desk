...
@section('content')
    ...
    @include('emails.include.paragraph', ['text' => __('verify_email.hi') .' '. $technician->first_name . ','])
    @include('emails.include.paragraph', ['text' => __('verify_email.p1')])
    @include('emails.include.button', 	 ['url' => url('verify-email/'.$technician->email_token), 'title' => __('verify_email.link_title')])
